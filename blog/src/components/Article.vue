<template>
	<div class="page-body container">
		<ol class="breadcrumb">
		  	<li>
		  		<router-link to="/">文档专区</router-link>
		  	</li>
		  	<li class="active">Promise</li>
		</ol>
		<div class="row">
			<div class="col-sm-12">
				<div class="jumbotron">
			...
			<div class="col-sm-12">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						...
						<h3><p class="text-danger">接下来，我们就按照费曼技巧来一步步的学习Promise是如何解决问题的</p></h3>
						...
						<div class="code-board">
							<table><tr>
								<td style="width: 813px; ">
									<div><span style="color: #F8F8F2;">Promise.</span><span style="color: #A6E22E;">all</span><span style="color: #F8F8F2;">(</span><span style="color: #66D9EF;" class="itlc">function</span><span style="color: #F8F8F2;">(){&nbsp;&nbsp;</span></div><div ><span style="color: #F8F8F2;">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span style="color: #F92672;">return</span> <span style="color: #F8F8F2;">[</span><span style="color: #F92672;">new</span> <span style="color: #F8F8F2;">Promise(</span><span style="color: #AE81FF;">A</span><span style="color: #F8F8F2;">),</span> <span style="color: #F92672;">new</span> <span style="color: #F8F8F2;">Promise(</span><span style="color: #AE81FF;">B</span><span style="color: #F8F8F2;">),</span> <span style="color: #F92672;">new</span> <span style="color: #F8F8F2;">Promise(</span><span style="color: #AE81FF;">C</span><span style="color: #F8F8F2;">)];</span></div><div ><span style="color: #F8F8F2;">}).</span><span style="color: #A6E22E;">then</span><span style="color: #F8F8F2;">(</span><span style="color: #66D9EF;" class="itlc">function</span><span style="color: #F8F8F2;">(){</span></div><div ><span style="color: #F8F8F2;">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span style="color: #AE81FF;">D</span><span style="color: #F8F8F2;">();</span></div><div><span style="color: #F8F8F2;">});</span></div></td></tr></table>
						</div>
						<p class="text-warning">
							<b>
						...
						<div class="code-board">
							<table><tr>
								<td style="  width: 813px; "><div><span style="color: #F8F8F2;">Promise.</span><span style="color: #A6E22E;">race</span><span style="color: #F8F8F2;">(</span><span style="color: #66D9EF;" class="itlc">function</span><span style="color: #F8F8F2;">(){&nbsp;&nbsp;</span></div><div ><span style="color: #F8F8F2;">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span style="color: #F92672;">return</span> <span style="color: #F8F8F2;">[</span><span style="color: #F92672;">new</span> <span style="color: #F8F8F2;">Promise(</span><span style="color: #AE81FF;">A</span><span style="color: #F8F8F2;">),</span> <span style="color: #F92672;">new</span> <span style="color: #F8F8F2;">Promise(</span><span style="color: #AE81FF;">B</span><span style="color: #F8F8F2;">),</span> <span style="color: #F92672;">new</span> <span style="color: #F8F8F2;">Promise(</span><span style="color: #AE81FF;">C</span><span style="color: #F8F8F2;">)];</span></div><div ><span style="color: #F8F8F2;">}).</span><span style="color: #A6E22E;">then</span><span style="color: #F8F8F2;">(</span><span style="color: #66D9EF;" class="itlc">function</span><span style="color: #F8F8F2;">(){</span></div><div ><span style="color: #F8F8F2;">&nbsp;&nbsp;&nbsp;&nbsp;</span> <span style="color: #AE81FF;">D</span><span style="color: #F8F8F2;">();</span></div><div><span style="color: #F8F8F2;">});</span></div></td></tr></table>
						</div>
					</div>
				</div>	
